...
public class JBatallaNaval extends javax.swing.JFrame {
 ...
 /** constructor
            ...
            new MouseAdapter() {
                    ...
                    if (nEstado==0){
                        ...
                        if (f!=pFila || c!=pCol){
                            pFila=f;
                            pCol=c;
                            if (verificarCeldasEnTablero(f, c)){
    ...
    public boolean verificarCeldasEnTablero(int f, int c){
        if (f<0) return false;
        if (c<0) return false;
        if (f>=8) return false;
        if (c>=8) return false;
    ...
    public boolean puedePonerBarco(int tab[][], int tam, int f, int c, int hor){
        ...
        for (int c2=c;c2<=c+tam*dc;c2++){
            for (int f2=f;f2<=f+tam*df;f2++){
                if (!verificarCeldasEnTablero(f2, c2)){
                    return false;
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JBatallaNaval.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
